  ...
  fdmm.consts.RegimentType = {
    Caucasus = {
      Ship = {
        Russia = {
          Divisions = {
            BlackSeaFleet = { -- TODO: Fix all BSF dates. They're in [,) instead of [,]. -NR
              ...
              Regiments = {
                ['30thSurfaceShip'] = {
                  ...
                  Units = {
                    ...
                    Bezukoriznenny = { -- Krivak Destroyer
                      Name = "Bezukoriznenny",
                      Type = fdmm.consts.UnitType.Ship.Frigate.KrivakII_Rezky,
                      Active = { { 1979, 1997 } },
                      ReportNaming = "SKR-%H %N",

...
local r=r:sub(1,t-1)if not fdmm.config.gpCache[e][r]then
...
function fdmm.utils.getGroupingComponentsWithSNC(e,t,i)assert(e,'Nonnull parameter: name')local n,e,r=fdmm.utils.getGroupingComponents(e)if string.isEmpty(n)and table.contains(t or{},(e..'_'))then
n=(e..'_')e=nil
...
function string.hasAnyPrefix(n,e)for r,e in pairs(e)do
...
s(o,o.All)end
local function i(e,r,i)for e,n in pairs(e)do
...
local function o(n,i)local function r(e,n)for e,r in pairs(e)do
if not string.hasAnyPrefix(e,a)then
if not n[e]then
n[e]=r
elseif n[e]~=r then
...
t(fdmm.consts.UnitType.Plane)t(fdmm.consts.UnitType.Helicopter)t(fdmm.consts.UnitType.Ground)t(fdmm.consts.UnitType.Ship)t(fdmm.consts.UnitType.Train)i(fdmm.consts.UnitType.Plane.All,fdmm.consts.UnitType.Static.Plane,'Planes')i(fdmm.consts.UnitType.Helicopter.All,fdmm.consts.UnitType.Static.Helicopter,'Helicopters')i(fdmm.consts.UnitType.Ground.All,fdmm.consts.UnitType.Static.Ground,'Unarmed')i(fdmm.consts.UnitType.Train.All,fdmm.consts.UnitType.Static.Train,'Unarmed')i(fdmm.consts.UnitType.Ship.All,fdmm.consts.UnitType.Static.Ship,'Ships')t(fdmm.consts.UnitType.Static)r(fdmm.consts.UnitType.Plane.All,fdmm.consts.UnitType.All)r(fdmm.consts.UnitType.Helicopter.All,fdmm.consts.UnitType.All)r(fdmm.consts.UnitType.Ground.All,fdmm.consts.UnitType.All)r(fdmm.consts.UnitType.Train.All,fdmm.consts.UnitType.All)r(fdmm.consts.UnitType.Ship.All,fdmm.consts.UnitType.All)r(fdmm.consts.UnitType.Static.All,fdmm.consts.UnitType.All)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.All)table.concatWith(fdmm.consts.UnitType.CarrierBorne,fdmm.consts.UnitType.Plane.CarrierBorne)table.concatWith(fdmm.consts.UnitType.CarrierBorne,fdmm.consts.UnitType.Helicopter.CarrierBorne)table.concatWith(fdmm.consts.UnitType.PlayerControllable,fdmm.consts.UnitType.Plane.PlayerControllable)table.concatWith(fdmm.consts.UnitType.PlayerControllable,fdmm.consts.UnitType.Helicopter.PlayerControllable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Plane.Unavailable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Helicopter.Unavailable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Ground.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Amphibious)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.HeavyWheeled)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Unavailable)n(fdmm.consts.UnitType.Plane)n(fdmm.consts.UnitType.Helicopter)n(fdmm.consts.UnitType.Ground)n(fdmm.consts.UnitType.Ship)n(fdmm.consts.UnitType.Train)n(fdmm.consts.UnitType.Static)e(fdmm.consts.UnitType.Plane)e(fdmm.consts.UnitType.Helicopter)e(fdmm.consts.UnitType.Ground)e(fdmm.consts.UnitType.Ship)e(fdmm.consts.UnitType.Train)o(fdmm.consts.UnitType.Plane,fdmm.consts.UnitType.Static)o(fdmm.consts.UnitType.Helicopter,fdmm.consts.UnitType.Static)o(fdmm.consts.UnitType.Ground,fdmm.consts.UnitType.Static)o(fdmm.consts.UnitType.Ship,fdmm.consts.UnitType.Static)o(fdmm.consts.UnitType.Train,fdmm.consts.UnitType.Static)e(fdmm.consts.UnitType.Static)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Plane.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Helicopter.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Ground.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Train.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Ship.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Static.Nicknaming)end
...
if not n then
env.info("  Missing fdmmUnitType for unitType=['"..(r or"<null>").."'] from "..i.."["..t.."].")end
end
end
...
function fdmm.unitTypes.getUnitReportName(e,n,r)local t=e..'Reporting'local e=fdmm.consts.UnitType[t][n]if string.isEmpty(e)then
local i=r or fdmm.unitTypes.getUnitTypeGroup(n)local s=i[t][n]local r,a,o=fdmm.utils.splitTuple(s)r=r or s
...
local i=math.floor((e+o)/2)local t=self.ranges[i]if n(t)>a then
o=i
elseif r(t)<a then
e=i+1
else
...
local r=table.getn(self.ranges)while e>=i do
if e>=1 and e<=r then
...
local i=self.ranges[e]if n(i)>r(i)then
...
function FDMMYearRange:getYearList()local i={}for t,e in ipairs(self.ranges or{})do
if n(e)~=r(e)then
...
function FDMMYearRange:addYearRange(o,a)assert(type(o)=='number',"Invalid parameter: startYear")assert(type(a)=='number',"Invalid parameter: endYear")local t={o,a}local e=table.getn(self.ranges)if e==0 or(o<=n(self.ranges[1])and a>=r(self.ranges[e]))then
...
return
elseif a<n(l)then
table.insert(self.ranges,e,t)self:_checkCombineNeighborsAt(e)return
end
end
local i=self:_indexOfRangeAdjToOrCont(a)local m=i and self.ranges[i]or nil
if m and o>r(m)then
table.insert(self.ranges,t)self:_checkCombineNeighborsAt(i+1)return
end
local o=s(o,l)local s=s(a,m)if o and s then
t={n(l),r(m)}self:_collapseRangesFromTo(e,i)table.insert(self.ranges,e,t)self:_checkCombineNeighborsAt(e)return
elseif not o and not s then
local n=a<n(m)if n then i=i-1 end
self:_collapseRangesFromTo(e,i)table.insert(self.ranges,e,t)self:_checkCombineNeighborsAt(e)return
else
if o then
self:_collapseRangesFromTo(e+1,i)self.ranges[e][2]=r(t)self:_checkCombineNeighborsAt(e)elseif s then
i=i-self:_collapseRangesFromTo(e,i-1)self.ranges[i][1]=n(t)self:_checkCombineNeighborsAt(i)end
return
end
end
...
function FDMMYearRange:removeYearRange(a,t)assert(type(a)=='number',"Invalid parameter: startYear")assert(type(t)=='number',"Invalid parameter: endYear")local e=table.getn(self.ranges)if e==0 or(a<=n(self.ranges[1])and t>=r(self.ranges[e]))then
self.ranges={}return
end
local c={a,t}local i=self:_indexOfRangeAdjToOrCont(a)local l=i and self.ranges[i]or nil
local e=self:_indexOfRangeAdjToOrCont(t)local m=e and self.ranges[e]or nil
local d=s(a,l)local u=s(t,m)local o=a<=n(l)local s=t<n(m)local n=t>=r(m)if o and(s or n)then
if s then e=e-1 end
self:_collapseRangesFromTo(i,e)return
elseif i==e and d and u then
c={t+1,r(l)}self.ranges[i][2]=a-1
table.insert(self.ranges,i+1,c)self:_checkValidRangeAt(i)self:_checkValidRangeAt(i+1)return
else
local r,s=i,e
if not o then r=i+1 end
if not n then s=e-1 end
e=e-self:_collapseRangesFromTo(r,s)if not o and d then
self.ranges[i][2]=a-1
...
env.error("FDMM: Failed parsing inactive years for regiment unit: '"..fdmm.regimentTypes.getObjReportNameInYear(e).."'.")env.error("FDMM:  Error: "..tostring(n))end
end
end
local e,r=e._yearRange:startYear(),e._yearRange:endYear()if type(e)=='number'and e<n[1]then n[1]=e end
if type(r)=='number'and r>n[2]then n[2]=r end
return n
end
...
function fdmm.regimentTypes.getObjNameInYear(e,n)return fdmm.regimentTypes._objForYear(e.Name,n)end
...
function fdmm.regimentTypes.getUnitHullNumberingInYear(n,e)return fdmm.regimentTypes._objForYear(n.HullNumbering,e)end
...
function fdmm.regimentTypes.dumpRegimentYearlyAvailability(s,a,o)env.info("FDMM: Dumping regiment yearly availability for years "..tostring(a).." to "..tostring(o).."...")local function i(n,e,r)env.info("FDMM: "..r.."Regiment: "..fdmm.regimentTypes.getObjReportNameInYear(n,e))for i,n in pairs(n.Units or{})do
if fdmm.regimentTypes.isRegimentUnitAvailableInYear(n,e)then
env.info("FDMM: "..r.."  Unit: "..fdmm.regimentTypes.getObjReportNameInYear(n,e))end
end
for t,n in pairs(n.Regiments or{})do
i(n,e,r.."  ")end
if n.Reinforcements then
env.info("FDMM: "..r.."  Reinforcements:")for a,t in pairs(n.Reinforcements.Units or{})do
if fdmm.regimentTypes.isRegimentUnitAvailableInYear(t,e)then
env.info("FDMM: "..r.."    Unit: "..fdmm.regimentTypes.getObjReportNameInYear(t,e))end
...
for e=a,o do
env.info("FDMM: Year: "..e)i(s,e,"")end
end
...
local function i(n,e)env.info("FDMM: "..e.."Regiment: "..fdmm.regimentTypes.getObjReportNameInYear(n,r))env.info("FDMM: "..e.."  _Active: "..JSON:encode(n._Active))for i,n in pairs(n.Units or{})do
env.info("FDMM: "..e.."  Unit: "..fdmm.regimentTypes.getObjReportNameInYear(n,r))env.info("FDMM: "..e.."    _Active: "..JSON:encode(n._yearRange:getYearList()))end
...
function FDMMCargoRoute:addSpawnLocation(r,n,e)table.insert(self.spawnLocs,{spawnFaction=r,spawnPoint=n,egressPoints=e or{}})end
...
function FDMMCargoRoute:addDirectionalLink(r,n,e)table.insert(self.dirLinks,{directionName=r,navigationPoint=n,ingressPoints=e or{}})end
...
local u={[fdmm.consts.CargoRouteGNPrefix.Land]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Land]or{},[fdmm.consts.CargoRouteGNPrefix.Train]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Train]or{},[fdmm.consts.CargoRouteGNPrefix.Air]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Air]or{},[fdmm.consts.CargoRouteGNPrefix.Sea]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Sea]or{}}function _processGroup(o,e,a)local n=fdmm.utils.removeNumericSuffix(fdmm.utils.removeGroupingPrefix(o))local r=fdmm.territories.all[n]if r~=nil then
local m=fdmm.cargoRoutes[n][a]local c=mist.getGroupRoute(o,false)local d=fdmm.utils.getFaction(string.notEmptyElse(e.units[1].unitName,e.country))local l=a:upperFirst()local u=table.concatedWith(fdmm.consts.CargoRouteGNPrefix,fdmm.consts.CargoRouteWPRoutePrefix[l])local n=nil
...
for m,n in ipairs(c)do
if string.isNotEmpty(n.name)and(n.name..'_')~=fdmm.consts.CargoRouteGNPrefix[l]then
local d,i,r=fdmm.utils.getGroupingComponentsWithSNC(n.name,u,fdmm.consts.CargoRouteWPRouteSuffix)if d==fdmm.consts.CargoRouteGNPrefix[l]then
...
while e>=0 do
local i=mist.vec.scalarMult(a,e*t)local r=mist.vec.add(r,i);COORDINATE:NewFromVec2(mist.utils.makeVec2(r)):Smoke(n)e=e-1
end
end
...
setmetatable(FDMMAirbase,{__index=FDMMFacility,__call=function(e,...)return e.new(...)end})function FDMMAirbase.new(n,r,e)local e=setmetatable(FDMMFacility.new(n,r,e),FDMMAirbase)return e
end
...
setmetatable(FDMMCommandCenter,{__index=FDMMFacility,__call=function(e,...)return e.new(...)end})function FDMMCommandCenter.new(r,e,n)local e=setmetatable(FDMMFacility.new(r,e,n),FDMMCommandCenter)return e
end
...
setmetatable(FDMMPort,{__index=FDMMFacility,__call=function(e,...)return e.new(...)end})function FDMMPort.new(e,n,r)local e=setmetatable(FDMMFacility.new(e,n,r),FDMMPort)return e
end
...
fdmm.regimentTypes.dumpRegimentActiveLists(fdmm.consts.RegimentType.Caucasus.Ship.USA.Divisions.SixthFleet)if fdmm.runMode==fdmm.RunMode.DevWithPostTests then
fdmm.config.runTestsScript()end
end

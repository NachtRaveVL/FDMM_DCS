...
for e,n in pairs(fdmm.setup)do
if n=="OnUpdate"then
fdmm.setup[e]=i
end
end
...
function table.concatWith(e,n)assert(e,'Nonnull parameter: tbl1')if n then
...
elseif e[n]~=t then
env.error("Group all list discrepancy for fdmmUnitType='"..n.."', groupAllList[fdmmUnitType]='"..e[n].."' ~= value='"..t.."'.")end
end
end
end
end
...
local function a(i,n)local function t(e,n)for e,i in pairs(e)do
if not fdmm.unitTypes._isReservedKey(e)then
if not n[e]then
n[e]=i
elseif n[e]~=i then
...
r(fdmm.consts.UnitType.Plane)r(fdmm.consts.UnitType.Helicopter)r(fdmm.consts.UnitType.Ground)r(fdmm.consts.UnitType.Ship)r(fdmm.consts.UnitType.Train)t(fdmm.consts.UnitType.Plane.All,fdmm.consts.UnitType.Static.Plane,'Planes')t(fdmm.consts.UnitType.Helicopter.All,fdmm.consts.UnitType.Static.Helicopter,'Helicopters')t(fdmm.consts.UnitType.Ground.All,fdmm.consts.UnitType.Static.Ground,'Unarmed')t(fdmm.consts.UnitType.Train.All,fdmm.consts.UnitType.Static.Train,'Unarmed')t(fdmm.consts.UnitType.Ship.All,fdmm.consts.UnitType.Static.Ship,'Ships')r(fdmm.consts.UnitType.Static)i(fdmm.consts.UnitType.Plane.All,fdmm.consts.UnitType.All)i(fdmm.consts.UnitType.Helicopter.All,fdmm.consts.UnitType.All)i(fdmm.consts.UnitType.Ground.All,fdmm.consts.UnitType.All)i(fdmm.consts.UnitType.Train.All,fdmm.consts.UnitType.All)i(fdmm.consts.UnitType.Ship.All,fdmm.consts.UnitType.All)i(fdmm.consts.UnitType.Static.All,fdmm.consts.UnitType.All)table.concatWith(fdmm.consts.UnitType.Airborne,fdmm.consts.UnitType.Ground.Airborne)table.concatWith(fdmm.consts.UnitType.Amphibious,fdmm.consts.UnitType.Ground.Amphibious)table.concatWith(fdmm.consts.UnitType.CarrierBorne,fdmm.consts.UnitType.Plane.CarrierBorne)table.concatWith(fdmm.consts.UnitType.CarrierBorne,fdmm.consts.UnitType.Helicopter.CarrierBorne)table.concatWith(fdmm.consts.UnitType.HeavyWheeled,fdmm.consts.UnitType.Ground.HeavyWheeled)table.concatWith(fdmm.consts.UnitType.Marines,fdmm.consts.UnitType.Ground.Marines)table.concatWith(fdmm.consts.UnitType.PlayerControllable,fdmm.consts.UnitType.Plane.PlayerControllable)table.concatWith(fdmm.consts.UnitType.PlayerControllable,fdmm.consts.UnitType.Helicopter.PlayerControllable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Plane.Unavailable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Helicopter.Unavailable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Ground.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Airborne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Amphibious)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.HeavyWheeled)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Marines)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.All)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Airborne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Amphibious)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.HeavyWheeled)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Marines)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Unavailable)n(fdmm.consts.UnitType.Plane)n(fdmm.consts.UnitType.Helicopter)n(fdmm.consts.UnitType.Ground)n(fdmm.consts.UnitType.Ship)n(fdmm.consts.UnitType.Train)n(fdmm.consts.UnitType.Static)e(fdmm.consts.UnitType.Plane)e(fdmm.consts.UnitType.Helicopter)e(fdmm.consts.UnitType.Ground)e(fdmm.consts.UnitType.Ship)e(fdmm.consts.UnitType.Train)a(fdmm.consts.UnitType.Plane,fdmm.consts.UnitType.Static)a(fdmm.consts.UnitType.Helicopter,fdmm.consts.UnitType.Static)a(fdmm.consts.UnitType.Ground,fdmm.consts.UnitType.Static)a(fdmm.consts.UnitType.Ship,fdmm.consts.UnitType.Static)a(fdmm.consts.UnitType.Train,fdmm.consts.UnitType.Static)e(fdmm.consts.UnitType.Static)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Plane.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Helicopter.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Ground.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Train.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Ship.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Static.Nicknaming)end
...
function fdmm.unitTypes.crossRefEntries()assert(db,"Missing module: db")assert(dbYears,"Missing module: dbYears")env.info("FDMM: Cross-referencing units...")local function e(t,e)for r,e in ipairs(e)do
local n=e.Name
...
if not i then
env.info("  Missing fdmmUnitType for unitType=['"..(n or"<null>").."'] from "..t.."["..r.."].")end
end
end
...
function fdmm.unitTypes.anyAvailableToCountryIn(e,i,n)local i=string.lower(i)for e,t in pairs(e)do
...
function fdmm.unitTypes.whichListedUnder(i,n)fdmm.utils.ensureReversedDict(n)local e={}for i,t in pairs(i)do
if not string.hasPrefix(i,'_')then
local r=fdmm.unitTypes.getUnitType(t)if n._rev[r]then
e[i]=t
end
end
end
...
local r=i or fdmm.unitTypes.getUnitTypeGroup(n)local s=r[a][n]local i,t,o=fdmm.utils.splitTuple(s)i=i or s
e=r.ReportNaming[n]local r=r.ProperNaming[n]if string.isNotEmpty(i)and string.contains(e,'%R')then
e=e:gsub('%%R',i)end
...
local e,o=1,table.getn(self.ranges)while e<o do
local t=math.floor((e+o)/2)local r=self.ranges[t]if n(r)>a then
o=t
elseif i(r)<a then
e=t+1
else
...
r={n(m),i(l)}self:_collapseRangesFromTo(e,t)table.insert(self.ranges,e,r)self:_checkCombineNeighborsAt(e)return
...
local c={a,r}local t=self:_indexOfRangeAdjToOrCont(a)local o=t and self.ranges[t]or nil
local e=self:_indexOfRangeAdjToOrCont(r)local m=e and self.ranges[e]or nil
local u=s(a,o)local d=s(r,m)local s=a<=n(o)local l=r<n(m)local n=r>=i(m)if s and(l or n)then
if l then e=e-1 end
self:_collapseRangesFromTo(t,e)return
elseif t==e and u and d then
c={r+1,i(o)}self.ranges[t][2]=a-1
table.insert(self.ranges,t+1,c)self:_checkValidRangeAt(t)self:_checkValidRangeAt(t+1)return
else
local i,o=t,e
if not s then i=t+1 end
if not n then o=e-1 end
e=e-self:_collapseRangesFromTo(i,o)if not s and u then
self.ranges[t][2]=a-1
self:_checkValidRangeAt(t)elseif not n and d then
self.ranges[e][1]=r+1
self:_checkValidRangeAt(e)end
return
end
...
function fdmm.regimentTypes.dumpRegimentYearlyAvailability(s,a,o)env.info("FDMM: Dumping regiment yearly availability for years "..tostring(a).." to "..tostring(o).."...")local function t(i,e,n)env.info("FDMM: "..n.."Regiment: "..fdmm.regimentTypes.getObjReportNameIn(i,e))for t,i in pairs(i.Units or{})do
...
function fdmm.unitTypes.saveWeaponTypeAvailability()end
function fdmm.unitTypes.saveWeaponTypeAvailability()end
end
...
e._functionList={}return e
end
function FDMMRunLoop:startAsCallback(e)end
function FDMMRunLoop:startAsCoroutine(e)end
function FDMMRunLoop:enqueueFuncAsync(e)end
function FDMMRunLoop:enqueueFuncSync(e)end
function FDMMRunLoop:_runQueuedFuncs()end
end
do
function fdmm.runLoop.startRunLoops()fdmm.runLoop.mainLoop=FDMMRunLoop.new("MainLoop")fdmm.runLoop.highPriorityLoop=FDMMRunLoop.new("HighPriorityLoop")fdmm.runLoop.medPriorityLoop=FDMMRunLoop.new("MedPriorityLoop")fdmm.runLoop.lowPriorityLoop=FDMMRunLoop.new("LowPriorityLoop")fdmm.runLoop.mainLoop:startAsCallback(.25)fdmm.runLoop.highPriorityLoop:startAsCoroutine(1)fdmm.runLoop.medPriorityLoop:startAsCoroutine(10)fdmm.runLoop.lowPriorityLoop:startAsCoroutine(50)end
end
...
setmetatable(FDMMResourceUnit,{__call=function(e,...)return e.new(...)end,})function FDMMResourceUnit.new(t,n,i,a,o,r)local e=setmetatable({},FDMMResourceUnit)e.fuelRP=t
e.armsRP=n
e.unitRP=i
e.maxFuelRP=a
e.maxArmsRP=o
...
function FDMMCargoRoute:addSpawnLocation(n,e,i)table.insert(self.spawnLocs,{spawnFaction=n,spawnPoint=e,egressPoints=i or{}})end
...
local d={[fdmm.consts.CargoRouteGNPrefix.Land]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Land]or{},[fdmm.consts.CargoRouteGNPrefix.Train]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Train]or{},[fdmm.consts.CargoRouteGNPrefix.Air]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Air]or{},[fdmm.consts.CargoRouteGNPrefix.Sea]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Sea]or{}}function _processGroup(a,e,o)local n=fdmm.utils.removeNumericSuffix(fdmm.utils.removeGroupingPrefix(a))local i=fdmm.territories.all[n]if i~=nil then
local l=fdmm.cargoRoutes[n][o]local u=mist.getGroupRoute(a,false)local d=fdmm.utils.getFaction(string.notEmptyElse(e.units[1].unitName,e.country))local m=o:upperFirst()local c=table.concatedWith(fdmm.consts.CargoRouteGNPrefix,fdmm.consts.CargoRouteWPRoutePrefix[m])local e=nil
...
for e,n in pairs(d[fdmm.consts.CargoRouteGNPrefix.Land])do
_processGroup(e,n,fdmm.enums.CargoRouteType.Land)end
for n,e in pairs(d[fdmm.consts.CargoRouteGNPrefix.Train])do
_processGroup(n,e,fdmm.enums.CargoRouteType.Train)end
for n,e in pairs(d[fdmm.consts.CargoRouteGNPrefix.Air])do
...
if e>1 then
local e=mist.utils.makeVec3(a)local e=mist.vec.sub(e,t)local i=mist.vec.mag(e)local a=mist.vec.scalarMult(e,1./i)local e=1
local n=i/e
while n>o do
e=e+1
n=i/e
...
while e>=0 do
local n=mist.vec.scalarMult(a,e*n)local n=mist.vec.add(t,n);COORDINATE:NewFromVec2(mist.utils.makeVec2(n)):Smoke(r)e=e-1
end
end
...
local r,e,o=fdmm.utils.getGroupingComponentsWithSNC(n.name,e,nil)if r==fdmm.consts.TerritoryWPFacilityPrefix.Airbase and string.isNotEmpty(e)then
...
setmetatable(FDMMFacility,{__call=function(e,...)return e.new(...)end})function FDMMFacility.new(i,t,n)local e=setmetatable({},FDMMFacility)e.name=i
e.centerPoint=t
e.territoryName=n
return e
end
...
setmetatable(FDMMCommandCenter,{__index=FDMMFacility,__call=function(e,...)return e.new(...)end})function FDMMCommandCenter.new(i,e,n)local e=setmetatable(FDMMFacility.new(i,e,n),FDMMCommandCenter)return e
end
...
setmetatable(FDMMFARP,{__index=FDMMFacility,__call=function(e,...)return e.new(...)end})function FDMMFARP.new(e,n,i)local e=setmetatable(FDMMFacility.new(e,n,i),FDMMFARP)return e
end
...
fdmm.runLoop.startRunLoops()else

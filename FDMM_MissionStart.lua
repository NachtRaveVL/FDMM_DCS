...
local t=fdmm.config.Config.updatedDCSDetected or
...
function table.contains(n,e)assert(n,'Nonnull parameter: tbl')assert(e,'Nonnull parameter: value')for t,n in pairs(n)do
if n==e then
return true
end
end
...
function table.concatedWith(n,t)assert(n or t,'Nonnull parameter: tbl1 or tbl2')local e={}if n then
...
function table.concatedWithi(e,n)assert(e or n,'Nonnull parameter: seq1 or seq2')local t={}if e then
...
o(a,a.All)end
local function i(e,i,t)for e,n in pairs(e)do
if not fdmm.unitTypes._isReservedKey(e)then
i[e]=(s[n]or t)..'::'..n
end
end
end
local function t(e,n)for e,t in pairs(e)do
if not fdmm.unitTypes._isReservedKey(e)then
...
local function r(t,i)local function n(e,t)for e,n in pairs(e)do
if not fdmm.unitTypes._isReservedKey(e)then
if not t[e]then
t[e]=n
elseif t[e]~=n then
env.error("Static report naming discrepancy for unitType='"..e.."', staticReportNaming[unitType]='"..t[e].."' ~= reportNaming='"..n.."'.")end
end
end
end
...
a(fdmm.consts.UnitType.Plane)a(fdmm.consts.UnitType.Helicopter)a(fdmm.consts.UnitType.Ground)a(fdmm.consts.UnitType.Ship)a(fdmm.consts.UnitType.Train)i(fdmm.consts.UnitType.Plane.All,fdmm.consts.UnitType.Static.Plane,'Planes')i(fdmm.consts.UnitType.Helicopter.All,fdmm.consts.UnitType.Static.Helicopter,'Helicopters')i(fdmm.consts.UnitType.Ground.All,fdmm.consts.UnitType.Static.Ground,'Unarmed')i(fdmm.consts.UnitType.Train.All,fdmm.consts.UnitType.Static.Train,'Unarmed')i(fdmm.consts.UnitType.Ship.All,fdmm.consts.UnitType.Static.Ship,'Ships')a(fdmm.consts.UnitType.Static)t(fdmm.consts.UnitType.Plane.All,fdmm.consts.UnitType.All)t(fdmm.consts.UnitType.Helicopter.All,fdmm.consts.UnitType.All)t(fdmm.consts.UnitType.Ground.All,fdmm.consts.UnitType.All)t(fdmm.consts.UnitType.Train.All,fdmm.consts.UnitType.All)t(fdmm.consts.UnitType.Ship.All,fdmm.consts.UnitType.All)t(fdmm.consts.UnitType.Static.All,fdmm.consts.UnitType.All)table.concatWith(fdmm.consts.UnitType.Airborne,fdmm.consts.UnitType.Ground.Airborne)table.concatWith(fdmm.consts.UnitType.Amphibious,fdmm.consts.UnitType.Ground.Amphibious)table.concatWith(fdmm.consts.UnitType.CarrierBorne,fdmm.consts.UnitType.Plane.CarrierBorne)table.concatWith(fdmm.consts.UnitType.CarrierBorne,fdmm.consts.UnitType.Helicopter.CarrierBorne)table.concatWith(fdmm.consts.UnitType.HeavyWheeled,fdmm.consts.UnitType.Ground.HeavyWheeled)table.concatWith(fdmm.consts.UnitType.Marines,fdmm.consts.UnitType.Ground.Marines)table.concatWith(fdmm.consts.UnitType.PlayerControllable,fdmm.consts.UnitType.Plane.PlayerControllable)table.concatWith(fdmm.consts.UnitType.PlayerControllable,fdmm.consts.UnitType.Helicopter.PlayerControllable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Plane.Unavailable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Helicopter.Unavailable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Ground.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Airborne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Amphibious)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.HeavyWheeled)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Marines)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.All)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Airborne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Amphibious)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.HeavyWheeled)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Marines)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Unavailable)n(fdmm.consts.UnitType.Plane)n(fdmm.consts.UnitType.Helicopter)n(fdmm.consts.UnitType.Ground)n(fdmm.consts.UnitType.Ship)n(fdmm.consts.UnitType.Train)n(fdmm.consts.UnitType.Static)e(fdmm.consts.UnitType.Plane)e(fdmm.consts.UnitType.Helicopter)e(fdmm.consts.UnitType.Ground)e(fdmm.consts.UnitType.Ship)e(fdmm.consts.UnitType.Train)r(fdmm.consts.UnitType.Plane,fdmm.consts.UnitType.Static)r(fdmm.consts.UnitType.Helicopter,fdmm.consts.UnitType.Static)r(fdmm.consts.UnitType.Ground,fdmm.consts.UnitType.Static)r(fdmm.consts.UnitType.Ship,fdmm.consts.UnitType.Static)r(fdmm.consts.UnitType.Train,fdmm.consts.UnitType.Static)e(fdmm.consts.UnitType.Static)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Plane.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Helicopter.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Ground.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Train.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Ship.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Static.Nicknaming)end
...
local e,i=db.getYearsLocal(e,t)n[string.lower(string.trim(t))]={e,i}end
else
n['all']={1900,9999}end
...
function fdmm.unitTypes.crossRefEntries()assert(db,"Missing module: db")assert(dbYears,"Missing module: dbYears")env.info("FDMM: Cross-referencing units...")local function e(i,e)for r,e in ipairs(e)do
local t=e.Name
...
if not n then
env.info("  Missing fdmmUnitType for unitType=['"..(t or"<null>").."'] from "..i.."["..r.."].")end
end
end
...
function fdmm.unitTypes.whichListedUnder(n,i)fdmm.utils.ensureReversedDict(i)local e={}for t,n in pairs(n)do
...
function fdmm.unitTypes.getUnitReportName(e,n,t)local r=e..'Reporting'local e=fdmm.consts.UnitType[r][n]if string.isEmpty(e)then
local i=t or fdmm.unitTypes.getUnitTypeGroup(n)local s=i[r][n]local t,a,o=fdmm.utils.splitTuple(s)t=t or s
e=i.ReportNaming[n]local i=i.ProperNaming[n]if string.isNotEmpty(t)and string.contains(e,'%R')then
e=e:gsub('%%R',t)end
...
local i=math.floor((n+o)/2)local a=self.ranges[i]if e(a)>r then
o=i
elseif t(a)<r then
n=i+1
else
...
function FDMMYearRange:_collapseRangesFromTo(i,e)local t=0
...
function FDMMYearRange:_checkCombineNeighborsAt(n)local i=table.getn(self.ranges)if n>=1 and n<=i then
if n+1<=i and o(e(self.ranges[n+1])-1,self.ranges[n])then
self.ranges[n+1][1]=e(self.ranges[n])table.remove(self.ranges,n)end
if n-1>=1 and o(t(self.ranges[n-1])+1,self.ranges[n])then
self.ranges[n-1][2]=t(self.ranges[n])table.remove(self.ranges,n)end
self:_checkValidRangeAt(n)end
end
function FDMMYearRange:_checkValidRangeAt(n)local i=table.getn(self.ranges)if n>=1 and n<=i then
local i=self.ranges[n]if e(i)>t(i)then
...
function FDMMYearRange:getYearList()local i={}for r,n in ipairs(self.ranges or{})do
if e(n)~=t(n)then
table.insert(i,n)else
table.insert(i,e(n))end
end
return i
end
...
function FDMMYearRange:addYearRange(s,a)assert(type(s)=='number',"Invalid parameter: startYear")assert(type(a)=='number',"Invalid parameter: endYear")local r={s,a}local n=table.getn(self.ranges)if n==0 or(s<=e(self.ranges[1])and a>=t(self.ranges[n]))then
self.ranges={r}self:_checkValidRangeAt(1)return
end
local n=self:_indexOfRangeAdjToOrCont(s)local m=n and self.ranges[n]or nil
if m then
if d(m,r)then
return
elseif a<e(m)then
...
local i=self:_indexOfRangeAdjToOrCont(a)local l=i and self.ranges[i]or nil
if l and s>t(l)then
table.insert(self.ranges,r)self:_checkCombineNeighborsAt(i+1)return
end
local s=o(s,m)local o=o(a,l)if s and o then
r={e(m),t(l)}self:_collapseRangesFromTo(n,i)table.insert(self.ranges,n,r)self:_checkCombineNeighborsAt(n)return
elseif not s and not o then
local e=a<e(l)if e then i=i-1 end
self:_collapseRangesFromTo(n,i)table.insert(self.ranges,n,r)self:_checkCombineNeighborsAt(n)return
else
if s then
self:_collapseRangesFromTo(n+1,i)self.ranges[n][2]=t(r)self:_checkCombineNeighborsAt(n)elseif o then
i=i-self:_collapseRangesFromTo(n,i-1)self.ranges[i][1]=e(r)self:_checkCombineNeighborsAt(i)end
return
end
end
...
function FDMMYearRange:removeYearRange(a,r)assert(type(a)=='number',"Invalid parameter: startYear")assert(type(r)=='number',"Invalid parameter: endYear")local n=table.getn(self.ranges)if n==0 or(a<=e(self.ranges[1])and r>=t(self.ranges[n]))then
self.ranges={}return
end
local c={a,r}local n=self:_indexOfRangeAdjToOrCont(a)local s=n and self.ranges[n]or nil
local i=self:_indexOfRangeAdjToOrCont(r)local m=i and self.ranges[i]or nil
local d=o(a,s)local u=o(r,m)local o=a<=e(s)local l=r<e(m)local e=r>=t(m)if o and(l or e)then
if l then i=i-1 end
self:_collapseRangesFromTo(n,i)return
elseif n==i and d and u then
c={r+1,t(s)}self.ranges[n][2]=a-1
table.insert(self.ranges,n+1,c)self:_checkValidRangeAt(n)self:_checkValidRangeAt(n+1)return
else
local s,t=n,i
if not o then s=n+1 end
if not e then t=i-1 end
i=i-self:_collapseRangesFromTo(s,t)if not o and d then
self.ranges[n][2]=a-1
self:_checkValidRangeAt(n)elseif not e and u then
self.ranges[i][1]=r+1
self:_checkValidRangeAt(i)end
return
end
end
...
local i={e,n}local e=self:_indexOfRangeAdjToOrCont(e)local e=e and self.ranges[e]or nil
if e and d(e,i)then
return true
end
...
local e,t=e._yearRange:startYear(),e._yearRange:endYear()if type(e)=='number'and e<n[1]then n[1]=e end
if type(t)=='number'and t>n[2]then n[2]=t end
return n
end
...
local t=nil
for r,e in ipairs(table.sortedKeysList(n))do
assert(type(e)=='number',"Invalid format: startYear")local n=n[e]assert(type(n)~='nil',"Invalid format.")if i==e then return n end
if i<e then return t or n end
t=n
end
return t
end
...
function fdmm.regimentTypes.dumpRegimentYearlyAvailability(o,a,r)env.info("FDMM: Dumping regiment yearly availability for years "..tostring(a).." to "..tostring(r).."...")local function i(n,e,t)env.info("FDMM: "..t.."Regiment: "..fdmm.regimentTypes.getObjReportNameIn(n,e))for i,n in pairs(n.Units or{})do
if fdmm.regimentTypes.isRegimentUnitAvailableIn(n,e)then
env.info("FDMM: "..t.."  Unit: "..fdmm.regimentTypes.getObjReportNameIn(n,e))end
end
for r,n in pairs(n.Regiments or{})do
i(n,e,t.."  ")end
if n.Reinforcements then
env.info("FDMM: "..t.."  Reinforcements:")for a,r in pairs(n.Reinforcements.Units or{})do
if fdmm.regimentTypes.isRegimentUnitAvailableIn(r,e)then
env.info("FDMM: "..t.."    Unit: "..fdmm.regimentTypes.getObjReportNameIn(r,e))end
...
function FDMMRunLoop:isTimeSliceOver(n)if self:isActiveLoop()then
local e=self.runStartTime+self.timeSlice-fdmm.utils.getTime()<=0
if e and n==true then
...
function fdmm.runLoop.stopExtRunLoops()local t={fdmm.runLoop.mainLoop,fdmm.runLoop.lowPriorityLoop,fdmm.runLoop.medPriorityLoop,fdmm.runLoop.highPriorityLoop}for e=table.getn(fdmm.runLoop._runLoopList),1,-1 do
local n=fdmm.runLoop._runLoopList[e]if not table.contains(t,n)then
n:stop(false)table.remove(fdmm.runLoop._runLoopList,e)end
end
end
end
...
setmetatable(FDMMResourceUnit,{__call=function(e,...)return e.new(...)end,})function FDMMResourceUnit.new(a,t,n,r,i,o)local e=setmetatable({},FDMMResourceUnit)e.fuelRP=a
e.armsRP=t
e.unitRP=n
e.maxFuelRP=r
e.maxArmsRP=i
...
function FDMMCargoRoute:addSpawnLocation(n,e,t)table.insert(self.spawnLocs,{spawnFaction=n,spawnPoint=e,egressPoints=t or{}})end
function FDMMCargoRoute:addFacilityLocation(n,e,t)table.insert(self.facilityLocs,{facilityName=n,facilityPoint=e,ingressPoints=t or{}})end
function FDMMCargoRoute:addDirectionalLink(e,n,t)table.insert(self.dirLinks,{directionName=e,navigationPoint=n,ingressPoints=t or{}})end
...
local d={[fdmm.consts.CargoRouteGNPrefix.Land]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Land]or{},[fdmm.consts.CargoRouteGNPrefix.Train]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Train]or{},[fdmm.consts.CargoRouteGNPrefix.Air]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Air]or{},[fdmm.consts.CargoRouteGNPrefix.Sea]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Sea]or{}}function _processGroup(o,n,a)local e=fdmm.utils.removeNumericSuffix(fdmm.utils.removeGroupingPrefix(o))local t=fdmm.territories.all[e]if t~=nil then
...
env.error('Cargo '..a.." routing group '"..o.."' failed to parse spawn route '"..(t or'<nil>').."'.")end
elseif e==n.Linkage then
if string.isNotEmpty(t)and r and s then
l:addDirectionalLink(t,r,s)else
env.error('Cargo '..a.." routing group '"..o.."' failed to parse linkage route '"..(t or'<nil>').."'.")end
elseif e==n.Facility then
if string.isNotEmpty(t)and r and s then
l:addFacilityLocation(t,r,s)else
env.error('Cargo '..a.." routing group '"..o.."' failed to parse facility route '"..(t or'<nil>').."'.")end
elseif e~=n.TBD then
...
while e>=0 do
local t=mist.vec.scalarMult(a,e*t)local t=mist.vec.add(r,t);COORDINATE:NewFromVec2(mist.utils.makeVec2(t)):Smoke(n)e=e-1
end
end

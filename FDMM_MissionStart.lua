...
local e=fdmm.config.Config.updatedDCSDetected or
fdmm.config.Config.updatedFDMMDetected
for n,i in pairs(fdmm.setup)do
if i=="OnUpdate"then
fdmm.setup[n]=e
end
end
...
function fdmm.config.loadConfigOrDefaults()env.info("FDDM: Loading Config or defaults...")local e=fdmm.fullPath.."data/Config.json"local e,n=pcall(fdmm.utils.decodeFromJSONFile,e)if e and n then
local e=fdmm.config.Config._tableVer
if e~=fdmm.config.Config._tableVer then
env.info("FDDM:   ...updating config to v"..e..".")table.concatWith(fdmm.config.Config,n)fdmm.config.Config._tableVer=e
end
else
...
local t=t:sub(1,r-1)if not fdmm.config.gpCache[e][t]then
...
function fdmm.utils.getGroupingComponentsWithSNC(e,r,t)assert(e,"Nonnull parameter: name")local i,e,n=fdmm.utils.getGroupingComponents(e)if string.isEmpty(i)and table.contains(r or{},(e..'_'))then
i=(e..'_')e=nil
...
function string.hasAnySuffix(n,e)assert(n,'Nonnull parameter: str')assert(e,'Nonnull parameter: suffixList')for i,e in pairs(e)do
...
function table.concatedWithi(e,i)assert(e or i,'Nonnull parameter: seq1 or seq2')local n={}if e then
...
a(o,o.All)end
local function t(e,i,t)for n,e in pairs(e)do
if not fdmm.unitTypes._isReservedKey(n)then
i[n]=(s[e]or t)..'::'..e
end
end
...
local function r(t,n)local function i(e,n)for e,i in pairs(e)do
if not fdmm.unitTypes._isReservedKey(e)then
if not n[e]then
n[e]=i
elseif n[e]~=i then
...
i(t.NATOReporting,n.NATOReporting)i(t.WTOReporting,n.WTOReporting)i(t.ReportNaming,n.ReportNaming)i(t.ProperNaming,n.ProperNaming)i(t.Nicknaming,n.Nicknaming)end
...
a(fdmm.consts.UnitType.Plane)a(fdmm.consts.UnitType.Helicopter)a(fdmm.consts.UnitType.Ground)a(fdmm.consts.UnitType.Ship)a(fdmm.consts.UnitType.Train)t(fdmm.consts.UnitType.Plane.All,fdmm.consts.UnitType.Static.Plane,'Planes')t(fdmm.consts.UnitType.Helicopter.All,fdmm.consts.UnitType.Static.Helicopter,'Helicopters')t(fdmm.consts.UnitType.Ground.All,fdmm.consts.UnitType.Static.Ground,'Unarmed')t(fdmm.consts.UnitType.Train.All,fdmm.consts.UnitType.Static.Train,'Unarmed')t(fdmm.consts.UnitType.Ship.All,fdmm.consts.UnitType.Static.Ship,'Ships')a(fdmm.consts.UnitType.Static)n(fdmm.consts.UnitType.Plane.All,fdmm.consts.UnitType.All)n(fdmm.consts.UnitType.Helicopter.All,fdmm.consts.UnitType.All)n(fdmm.consts.UnitType.Ground.All,fdmm.consts.UnitType.All)n(fdmm.consts.UnitType.Train.All,fdmm.consts.UnitType.All)n(fdmm.consts.UnitType.Ship.All,fdmm.consts.UnitType.All)n(fdmm.consts.UnitType.Static.All,fdmm.consts.UnitType.All)table.concatWith(fdmm.consts.UnitType.Airborne,fdmm.consts.UnitType.Ground.Airborne)table.concatWith(fdmm.consts.UnitType.Amphibious,fdmm.consts.UnitType.Ground.Amphibious)table.concatWith(fdmm.consts.UnitType.CarrierBorne,fdmm.consts.UnitType.Plane.CarrierBorne)table.concatWith(fdmm.consts.UnitType.CarrierBorne,fdmm.consts.UnitType.Helicopter.CarrierBorne)table.concatWith(fdmm.consts.UnitType.HeavyWheeled,fdmm.consts.UnitType.Ground.HeavyWheeled)table.concatWith(fdmm.consts.UnitType.Marines,fdmm.consts.UnitType.Ground.Marines)table.concatWith(fdmm.consts.UnitType.PlayerControllable,fdmm.consts.UnitType.Plane.PlayerControllable)table.concatWith(fdmm.consts.UnitType.PlayerControllable,fdmm.consts.UnitType.Helicopter.PlayerControllable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Plane.Unavailable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Helicopter.Unavailable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Ground.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Airborne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Amphibious)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.HeavyWheeled)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Marines)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.All)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Airborne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Amphibious)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.HeavyWheeled)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Marines)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Unavailable)i(fdmm.consts.UnitType.Plane)i(fdmm.consts.UnitType.Helicopter)i(fdmm.consts.UnitType.Ground)i(fdmm.consts.UnitType.Ship)i(fdmm.consts.UnitType.Train)i(fdmm.consts.UnitType.Static)e(fdmm.consts.UnitType.Plane)e(fdmm.consts.UnitType.Helicopter)e(fdmm.consts.UnitType.Ground)e(fdmm.consts.UnitType.Ship)e(fdmm.consts.UnitType.Train)r(fdmm.consts.UnitType.Plane,fdmm.consts.UnitType.Static)r(fdmm.consts.UnitType.Helicopter,fdmm.consts.UnitType.Static)r(fdmm.consts.UnitType.Ground,fdmm.consts.UnitType.Static)r(fdmm.consts.UnitType.Ship,fdmm.consts.UnitType.Static)r(fdmm.consts.UnitType.Train,fdmm.consts.UnitType.Static)e(fdmm.consts.UnitType.Static)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Plane.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Helicopter.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Ground.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Train.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Ship.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Static.Nicknaming)end
...
function fdmm.unitTypes.whichAvailableToCountryIn(t,e,i)local n={}local a=string.lower(e)for t,r in pairs(t)do
...
function fdmm.unitTypes.anyAvailableToCountryIn(e,i,n)local t=string.lower(i)for e,i in pairs(e)do
...
local t=i or fdmm.unitTypes.getUnitTypeGroup(n)local o=t[r][n]local i,a,s=fdmm.utils.splitTuple(o)i=i or o
...
local t=math.floor((e+a)/2)local r=self.ranges[t]if n(r)>o then
a=t
elseif i(r)<o then
e=t+1
else
...
local i=table.getn(self.ranges)while e>=t do
if e>=1 and e<=i then
...
local d={a,r}local e=self:_indexOfRangeAdjToOrCont(a)local l=e and self.ranges[e]or nil
local t=self:_indexOfRangeAdjToOrCont(r)local m=t and self.ranges[t]or nil
local c=s(a,l)local s=s(r,m)local o=a<=n(l)local u=r<n(m)local n=r>=i(m)if o and(u or n)then
if u then t=t-1 end
self:_collapseRangesFromTo(e,t)return
elseif e==t and c and s then
d={r+1,i(l)}self.ranges[e][2]=a-1
table.insert(self.ranges,e+1,d)self:_checkValidRangeAt(e)self:_checkValidRangeAt(e+1)return
else
local m,i=e,t
if not o then m=e+1 end
if not n then i=t-1 end
t=t-self:_collapseRangesFromTo(m,i)if not o and c then
self.ranges[e][2]=a-1
self:_checkValidRangeAt(e)elseif not n and s then
self.ranges[t][1]=r+1
...
local t={e,n}local e=self:_indexOfRangeAdjToOrCont(e)local e=e and self.ranges[e]or nil
if e and d(e,t)then
return true
end
...
local n,i=pcall(e._yearRange.removeYearsFromList,e._yearRange,e.Inactive)if not n then
env.error("FDMM: Failed parsing inactive years for regiment unit: '"..fdmm.regimentTypes.getObjReportNameIn(e).."'.")env.error("FDMM:  Error: "..tostring(i))end
end
end
...
function fdmm.regimentTypes._objForYear(e,t)if type(e)=='table'then
local i=nil
for r,n in ipairs(table.sortedKeysList(e))do
assert(type(n)=='number',"Invalid format: startYear")local e=e[n]assert(type(e)~='nil',"Invalid format.")if t==n then return e end
...
function fdmm.regimentTypes.dumpRegimentYearlyAvailability(o,a,r)env.info("FDMM: Dumping regiment yearly availability for years "..tostring(a).." to "..tostring(r).."...")local function t(n,e,i)env.info("FDMM: "..i.."Regiment: "..fdmm.regimentTypes.getObjReportNameIn(n,e))for t,n in pairs(n.Units or{})do
...
self.isRunning=true
local e,n=pcall(self._main,self)if not e then
env.error("FDMM: Runloop '"..self.name.."' experienced an execution failure in main.")env.error("FDMM:   Error: "..tostring(n))end
...
function FDMMRunLoop:enqueueFuncSync(i,e)if self:isActiveLoop()then
i(table.unpack(e))else
local n=true
table.insert(self.functionList,{function()local i,e=pcall(i,table.unpack(e))n=false
return i,e
end,e})while n do
...
setmetatable(FDMMResourceUnit,{__call=function(e,...)return e.new(...)end,})function FDMMResourceUnit.new(o,a,r,i,t,n)local e=setmetatable({},FDMMResourceUnit)e.fuelRP=o
e.armsRP=a
e.unitRP=r
e.maxFuelRP=i
e.maxArmsRP=t
...
function FDMMCargoRoute:addFacilityLocation(e,i,n)table.insert(self.facilityLocs,{facilityName=e,facilityPoint=i,ingressPoints=n or{}})end
...
local u={[fdmm.consts.CargoRouteGNPrefix.Land]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Land]or{},[fdmm.consts.CargoRouteGNPrefix.Train]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Train]or{},[fdmm.consts.CargoRouteGNPrefix.Air]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Air]or{},[fdmm.consts.CargoRouteGNPrefix.Sea]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Sea]or{}}function _processGroup(a,e,o)local n=fdmm.utils.removeNumericSuffix(fdmm.utils.removeGroupingPrefix(a))local i=fdmm.territories.all[n]if i~=nil then
local l=fdmm.cargoRoutes[n][o]local c=mist.getGroupRoute(a,false)local d=fdmm.utils.getFaction(string.notEmptyElse(e.units[1].unitName,e.country))local m=o:upperFirst()local u=table.concatedWith(fdmm.consts.CargoRouteGNPrefix,fdmm.consts.CargoRouteWPRoutePrefix[m])local n=nil
...
env.error('Cargo '..o.." routing group '"..a.."' failed to parse spawn route '"..(i or'<nil>').."'.")end
elseif n==e.Linkage then
if string.isNotEmpty(i)and r and s then
l:addDirectionalLink(i,r,s)else
env.error('Cargo '..o.." routing group '"..a.."' failed to parse linkage route '"..(i or'<nil>').."'.")end
elseif n==e.Facility then
if string.isNotEmpty(i)and r and s then
l:addFacilityLocation(i,r,s)else
env.error('Cargo '..o.." routing group '"..a.."' failed to parse facility route '"..(i or'<nil>').."'.")end
elseif n~=e.TBD then
...
env.error('Cargo '..o.." routing group '"..a.."' unknown WP '"..(n.name or'<nil>').."' at WP index "..l..'.')end
...
env.error('Cargo '..o.." routing group '"..a.."' unknown spawn WP '"..(n.name or'<nil>').."' at WP index "..l..'.')end
...
env.error('Cargo '..o.." routing group '"..a.."' unknown linkage WP '"..(n.name or'<nil>').."' at WP index "..l..'.')end
...
env.error('Cargo '..o.." routing group '"..a.."' unknown facility WP '"..(n.name or'<nil>').."' at WP index "..l..'.')end
else
env.error('Cargo '..o.." routing group '"..a.."' unknown routing WP '"..(n.name or'<nil>').."' at WP index "..l..'.')end
end
end
...
setmetatable(FDMMPort,{__index=FDMMFacility,__call=function(e,...)return e.new(...)end})function FDMMPort.new(n,e,i)local e=setmetatable(FDMMFacility.new(n,e,i),FDMMPort)return e
end

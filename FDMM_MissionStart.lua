...
function table.contains(n,e)for r,n in pairs(n)do
if n==e then
return true
end
end
...
s(a,a.All)end
local function a(e,r,i)for e,n in pairs(e)do
...
local function i(i,r)local function n(e,r)for e,n in pairs(e)do
if not string.hasAnyPrefix(e,o)then
if not r[e]then
r[e]=n
elseif r[e]~=n then
...
env.info("---FDMM_UnitTypes End---");end)__DISTILLER:define("FDMM_RegimentTypes",function(e)env.info("---FDMM_RegimentTypes Start---");e('Additions/FDMM_LuaAdditions')fdmm.regimentTypes={}do
fdmm.consts.RegimentType={}function fdmm.regimentTypes.processEntries()end
end
...
setmetatable(FDMMResourceUnit,{__call=function(e,...)return e.new(...)end,})function FDMMResourceUnit.new(o,r,i,n,a,t)local e=setmetatable({},FDMMResourceUnit)e.fuelRP=o
e.armsRP=r
e.unitRP=i
e.maxFuelRP=n
e.maxArmsRP=a
...
local c={[fdmm.consts.CargoRouteGNPrefix.Land]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Land]or{},[fdmm.consts.CargoRouteGNPrefix.Train]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Train]or{},[fdmm.consts.CargoRouteGNPrefix.Air]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Air]or{},[fdmm.consts.CargoRouteGNPrefix.Sea]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Sea]or{}}function _processGroup(o,e,a)local n=fdmm.utils.removeNumericSuffix(fdmm.utils.removeGroupingPrefix(o))local r=fdmm.territories.all[n]if r~=nil then
...
local n={Spawn='spawn',Linkage='linkage',Facility='facility',TBD='_'}local r,t,s=nil,nil,{}function _updateScanner(i,l)if e==n.TBD and i~=nil and i~=n.TBD then
e=i
...
local d,i,r=fdmm.utils.getGroupingComponentsWithSNC(e.name,c,fdmm.consts.CargoRouteWPRouteSuffix)if d==fdmm.consts.CargoRouteGNPrefix[l]then
...
for e,n in pairs(c[fdmm.consts.CargoRouteGNPrefix.Land])do
...
for e,n in pairs(c[fdmm.consts.CargoRouteGNPrefix.Air])do
...
setmetatable(FDMMCommandCenter,{__index=FDMMFacility,__call=function(e,...)return e.new(...)end})function FDMMCommandCenter.new(e,n,r)local e=setmetatable(FDMMFacility.new(e,n,r),FDMMCommandCenter)return e
end
...
setmetatable(FDMMOilField,{__index=FDMMFacility,__call=function(e,...)return e.new(...)end})function FDMMOilField.new(e,r,n)local e=setmetatable(FDMMFacility.new(e,r,n),FDMMOilField)return e
end

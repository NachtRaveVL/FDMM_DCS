...
function fdmm.config.createGPCache()fdmm.config.gpCache={}local t={'AIRB_','ARMP_','CMDC_','FARP_','OILF_','PORT_','UNTF_'}for n,i in pairs(mist.DBs.groupsByName)do
...
function string.hasAnySuffix(e,n)for i,n in pairs(n)do
...
r(fdmm.consts.UnitType.Plane)r(fdmm.consts.UnitType.Helicopter)r(fdmm.consts.UnitType.Ground)r(fdmm.consts.UnitType.Ship)r(fdmm.consts.UnitType.Train)n(fdmm.consts.UnitType.Static.Plane,'Planes',fdmm.consts.UnitType.Plane.All)n(fdmm.consts.UnitType.Static.Helicopter,'Helicopters',fdmm.consts.UnitType.Helicopter.All)n(fdmm.consts.UnitType.Static.Ground,'Unarmed',fdmm.consts.UnitType.Ground.All)n(fdmm.consts.UnitType.Static.Train,'Unarmed',fdmm.consts.UnitType.Train.All)n(fdmm.consts.UnitType.Static.Ship,'Ships',fdmm.consts.UnitType.Ship.All)r(fdmm.consts.UnitType.Static)table.concatWith(fdmm.consts.UnitType.All,fdmm.consts.UnitType.Plane.All)table.concatWith(fdmm.consts.UnitType.All,fdmm.consts.UnitType.Helicopter.All)table.concatWith(fdmm.consts.UnitType.All,fdmm.consts.UnitType.Ground.All)table.concatWith(fdmm.consts.UnitType.All,fdmm.consts.UnitType.Train.All)table.concatWith(fdmm.consts.UnitType.All,fdmm.consts.UnitType.Ship.All)a(fdmm.consts.UnitType.Static.All,fdmm.consts.UnitType.All)fdmm.consts.UnitType.All._rev={}table.concatWith(fdmm.consts.UnitType.All._rev,fdmm.consts.UnitType.Plane.All._rev)table.concatWith(fdmm.consts.UnitType.All._rev,fdmm.consts.UnitType.Helicopter.All._rev)table.concatWith(fdmm.consts.UnitType.All._rev,fdmm.consts.UnitType.Ground.All._rev)table.concatWith(fdmm.consts.UnitType.All._rev,fdmm.consts.UnitType.Train.All._rev)table.concatWith(fdmm.consts.UnitType.All._rev,fdmm.consts.UnitType.Ship.All._rev)table.concatWith(fdmm.consts.UnitType.All._rev,fdmm.consts.UnitType.Static.All._rev)e(fdmm.consts.UnitType.Plane,false)e(fdmm.consts.UnitType.Helicopter,false)e(fdmm.consts.UnitType.Ground,false)e(fdmm.consts.UnitType.Static,true)end
...
function fdmm.unitTypes.getNATOUnitReportName(e,n)local n=n or fdmm.unitTypes.getUnitTypeGroup(e)local i=n.NATOReporting[e]local e=n.ReportNaming[e]or i
local n,r=fdmm.utils.splitDoublet(i)n=n or i
if string.isNotEmpty(e)and string.isNotEmpty(n)and
string.contains(e,'%%R')then
e=e:gsub('%%R',n)end
...
function fdmm.unitTypes.getWTOUnitReportName(e,n)local n=n or fdmm.unitTypes.getUnitTypeGroup(e)local r=n.WTOReporting[e]local e=n.ReportNaming[e]or r
local i,n=fdmm.utils.splitDoublet(r)i=i or r
if string.isNotEmpty(e)and string.contains(e,'%%R')then
e=e:gsub('%%R',i)end
if string.isNotEmpty(n)and not string.contains(e,n)then
e=e..' '..n
end
return e
end
function fdmm.unitTypes.dumpUnitReportNames()local function r(n)for i,e in pairs(n.All)do
...
r(fdmm.consts.UnitType.Ground)end
end
...
setmetatable(FDMMResourceUnit,{__call=function(e,...)return e.new(...)end,})function FDMMResourceUnit.new(n,i,r,a,t,o)local e=setmetatable({},FDMMResourceUnit)e.fuelRP=n
e.armsRP=i
e.unitRP=r
e.maxFuelRP=a
e.maxArmsRP=t
...
local m={[fdmm.consts.CargoRouteGNPrefix.Land]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Land]or{},[fdmm.consts.CargoRouteGNPrefix.Train]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Train]or{},[fdmm.consts.CargoRouteGNPrefix.Air]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Air]or{},[fdmm.consts.CargoRouteGNPrefix.Sea]=fdmm.config.gpCache[fdmm.consts.CargoRouteGNPrefix.Sea]or{}}function _processGroup(o,e,a)local n=fdmm.utils.removeNumericSuffix(fdmm.utils.removeGroupingPrefix(o))local i=fdmm.territories.all[n]if i~=nil then
local d=fdmm.cargoRoutes[n][a]local c=mist.getGroupRoute(o,false)local m=fdmm.utils.getFaction(string.notEmptyElse(e.units[1].unitName,e.country))local l=a:upperFirst()local u=table.concatedWith(fdmm.consts.CargoRouteGNPrefix,fdmm.consts.CargoRouteWPRoutePrefix[l])local e=nil
...
local m,r,i=fdmm.utils.getGroupingComponentsWithSNC(e.name,u,fdmm.consts.CargoRouteWPRouteSuffix)if m==fdmm.consts.CargoRouteGNPrefix[l]then
...
for n,e in pairs(m[fdmm.consts.CargoRouteGNPrefix.Land])do
_processGroup(n,e,fdmm.enums.CargoRouteType.Land)end
for e,n in pairs(m[fdmm.consts.CargoRouteGNPrefix.Train])do
...
if e>1 then
local e=mist.utils.makeVec3(a)local e=mist.vec.sub(e,r)local n=mist.vec.mag(e)local a=mist.vec.scalarMult(e,1./n)local e=1
local i=n/e
while i>o do
e=e+1
i=n/e
...
while e>=0 do
local n=mist.vec.scalarMult(a,e*i)local n=mist.vec.add(r,n);COORDINATE:NewFromVec2(mist.utils.makeVec2(n)):Smoke(t)e=e-1
end
end
...
fdmm.unitTypes.dumpUnitReportNames()fdmm.config.createGPCache()fdmm.territory.createTerritories()fdmm.territory.createFacilities()fdmm.cargoRoute.createCargoRoutes()fdmm.territory.buildFacilities()trigger.action.outText("FDMM Started",10)end

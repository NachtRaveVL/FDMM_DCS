...
s(a,a.All)end
local function a(e,i,r)for n,e in pairs(e)do
if not string.hasAnyPrefix(n,o)then
i[n]=(m[e]or r)..'::'..e
end
end
end
local function s(e,i)for e,r in pairs(e)do
if not string.hasAnyPrefix(e,o)then
local t,t,n=fdmm.utils.splitTuple(r)n=n or r
if not i[e]then
i[e]=n
elseif i[e]~=n then
...
if not string.hasAnyPrefix(e,o)then
local r,r,e=fdmm.utils.splitTuple(i)e=e or i
...
local r=n.All[i]local t,t,e=fdmm.utils.splitTuple(r)e=e or r
...
setmetatable(FDMMResourceUnit,{__call=function(e,...)return e.new(...)end,})function FDMMResourceUnit.new(t,r,a,o,i,n)local e=setmetatable({},FDMMResourceUnit)e.fuelRP=t
e.armsRP=r
e.unitRP=a
e.maxFuelRP=o
e.maxArmsRP=i
...
local m=fdmm.cargoRoutes[n][o]local u=mist.getGroupRoute(a,false)local d=fdmm.utils.getFaction(string.notEmptyElse(e.units[1].unitName,e.country))local l=o:upperFirst()local c=table.concatedWith(fdmm.consts.CargoRouteGNPrefix,fdmm.consts.CargoRouteWPRoutePrefix[l])local n=nil
local e={Spawn='spawn',Linkage='linkage',Facility='facility',TBD='_'}local i,t,s=nil,nil,{}function _updateScanner(r,l)if n==e.TBD and r~=nil and r~=e.TBD then
n=r
...
local d,r,i=fdmm.utils.getGroupingComponentsWithSNC(n.name,c,fdmm.consts.CargoRouteWPRouteSuffix)if d==fdmm.consts.CargoRouteGNPrefix[l]then
if i==fdmm.consts.CargoRouteWPRouteSuffix.Egress or
i==fdmm.consts.CargoRouteWPRouteSuffix.Ingress then
_updateScanner(e.TBD,r)table.insert(s,fdmm.utils.rposFromRPoint(n))elseif i==fdmm.consts.CargoRouteWPRouteSuffix.Spawn then
_updateScanner(e.Spawn,r)t=fdmm.utils.rposFromRPoint(n)elseif i==fdmm.consts.CargoRouteWPRouteSuffix.Linkage then
_updateScanner(e.Linkage,r)t=fdmm.utils.rposFromRPoint(n)elseif i==fdmm.consts.CargoRouteWPRouteSuffix.Facility then
_updateScanner(e.Facility,r)t=fdmm.utils.rposFromRPoint(n)elseif not(string.isEmpty(r)and string.isEmpty(i))then
...
_updateScanner(e.Spawn,r)t=fdmm.utils.rposFromRPoint(n)elseif i==fdmm.consts.CargoRouteWPRouteSuffix.Egress then
_updateScanner(e.Spawn,r)table.insert(s,fdmm.utils.rposFromRPoint(n))elseif not(string.isEmpty(r)and string.isEmpty(i))then
...
if string.isEmpty(i)then
_updateScanner(e.Linkage,r)t=fdmm.utils.rposFromRPoint(n)elseif i==fdmm.consts.CargoRouteWPRouteSuffix.Ingress then
_updateScanner(e.Linkage,r)table.insert(s,fdmm.utils.rposFromRPoint(n))elseif not(string.isEmpty(r)and string.isEmpty(i))then
...
if string.isEmpty(i)then
_updateScanner(e.Facility,r)t=fdmm.utils.rposFromRPoint(n)elseif i==fdmm.consts.CargoRouteWPRouteSuffix.Ingress then
_updateScanner(e.Facility,r)table.insert(s,fdmm.utils.rposFromRPoint(n))elseif not(string.isEmpty(r)and string.isEmpty(i))then
...
env.error("Territory group '"..a.."' unknown facility WP '"..(n.name or'<nil>').."' at WP index "..o..'.')end
end
end
else

...
function fdmm.utils.getGroupingComponentsWithSNC(e,t,i)assert(e,'Nonnull parameter: name')local r,e,n=fdmm.utils.getGroupingComponents(e)if string.isEmpty(r)and table.contains(t or{},(e..'_'))then
r=(e..'_')e=nil
...
function fdmm.utils.getFaction(e)assert(e,'Nonnull parameter: name')e=fdmm.utils.removeNumericSuffix(e)for n,r in pairs(fdmm.enums.Faction)do
if r:lower()==e:lower()then
return n
end
end
...
function string.hasAnySuffix(e,n)for r,n in pairs(n)do
...
s(a,a.All)end
local function i(e,i,r)for n,e in pairs(e)do
...
local function t(i,r)local function n(e,r)for e,n in pairs(e)do
if not string.hasAnyPrefix(e,o)then
if not r[e]then
r[e]=n
elseif r[e]~=n then
...
n(i.NATOReporting,r.NATOReporting)n(i.WTOReporting,r.WTOReporting)n(i.ReportNaming,r.ReportNaming)n(i.ProperNaming,r.ProperNaming)n(i.Nicknaming,r.Nicknaming)end
...
a(fdmm.consts.UnitType.Plane)a(fdmm.consts.UnitType.Helicopter)a(fdmm.consts.UnitType.Ground)a(fdmm.consts.UnitType.Ship)a(fdmm.consts.UnitType.Train)i(fdmm.consts.UnitType.Plane.All,fdmm.consts.UnitType.Static.Plane,'Planes')i(fdmm.consts.UnitType.Helicopter.All,fdmm.consts.UnitType.Static.Helicopter,'Helicopters')i(fdmm.consts.UnitType.Ground.All,fdmm.consts.UnitType.Static.Ground,'Unarmed')i(fdmm.consts.UnitType.Train.All,fdmm.consts.UnitType.Static.Train,'Unarmed')i(fdmm.consts.UnitType.Ship.All,fdmm.consts.UnitType.Static.Ship,'Ships')a(fdmm.consts.UnitType.Static)r(fdmm.consts.UnitType.Plane.All,fdmm.consts.UnitType.All)r(fdmm.consts.UnitType.Helicopter.All,fdmm.consts.UnitType.All)r(fdmm.consts.UnitType.Ground.All,fdmm.consts.UnitType.All)r(fdmm.consts.UnitType.Train.All,fdmm.consts.UnitType.All)r(fdmm.consts.UnitType.Ship.All,fdmm.consts.UnitType.All)r(fdmm.consts.UnitType.Static.All,fdmm.consts.UnitType.All)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.All)table.concatWith(fdmm.consts.UnitType.CarrierBorne,fdmm.consts.UnitType.Plane.CarrierBorne)table.concatWith(fdmm.consts.UnitType.CarrierBorne,fdmm.consts.UnitType.Helicopter.CarrierBorne)table.concatWith(fdmm.consts.UnitType.PlayerControllable,fdmm.consts.UnitType.Plane.PlayerControllable)table.concatWith(fdmm.consts.UnitType.PlayerControllable,fdmm.consts.UnitType.Helicopter.PlayerControllable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Plane.Unavailable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Helicopter.Unavailable)table.concatWith(fdmm.consts.UnitType.Unavailable,fdmm.consts.UnitType.Ground.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Plane.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Helicopter.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Amphibious)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.HeavyWheeled)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Ground.Unavailable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.CarrierBorne)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.PlayerControllable)fdmm.utils.ensureReversedDict(fdmm.consts.UnitType.Unavailable)n(fdmm.consts.UnitType.Plane)n(fdmm.consts.UnitType.Helicopter)n(fdmm.consts.UnitType.Ground)n(fdmm.consts.UnitType.Ship)n(fdmm.consts.UnitType.Train)n(fdmm.consts.UnitType.Static)e(fdmm.consts.UnitType.Plane)e(fdmm.consts.UnitType.Helicopter)e(fdmm.consts.UnitType.Ground)e(fdmm.consts.UnitType.Ship)e(fdmm.consts.UnitType.Train)t(fdmm.consts.UnitType.Plane,fdmm.consts.UnitType.Static)t(fdmm.consts.UnitType.Helicopter,fdmm.consts.UnitType.Static)t(fdmm.consts.UnitType.Ground,fdmm.consts.UnitType.Static)t(fdmm.consts.UnitType.Ship,fdmm.consts.UnitType.Static)t(fdmm.consts.UnitType.Train,fdmm.consts.UnitType.Static)e(fdmm.consts.UnitType.Static)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Plane.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Helicopter.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Ground.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Train.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Ship.Nicknaming)table.concatWith(fdmm.consts.UnitType.Nicknaming,fdmm.consts.UnitType.Static.Nicknaming)end
...
function fdmm.unitTypes.getUnitReportName(e,n,r)local i=e..'Reporting'local e=fdmm.consts.UnitType[i][n]if string.isEmpty(e)then
local t=r or fdmm.unitTypes.getUnitTypeGroup(n)local s=t[i][n]local r,a,o=fdmm.utils.splitTuple(s)r=r or s
e=t.ReportNaming[n]local t=t.ProperNaming[n]if string.isNotEmpty(r)and string.contains(e,'%R')then
e=e:gsub('%%R',r)end
...
local i=math.floor((n+a)/2)local t=self.ranges[i]if e(t)>o then
a=i
elseif r(t)<o then
n=i+1
else
...
if n-1>=1 and o(r(self.ranges[n-1])+1,self.ranges[n])then
self.ranges[n-1][2]=r(self.ranges[n])table.remove(self.ranges,n)end
...
local i=self.ranges[n]if e(i)>r(i)then
...
function FDMMYearRange:getYearList()local i={}for t,n in ipairs(self.ranges or{})do
if e(n)~=r(n)then
...
function FDMMYearRange:addYearRange(s,a)assert(type(s)=='number',"Invalid parameter: startYear")assert(type(a)=='number',"Invalid parameter: endYear")local t={s,a}local n=table.getn(self.ranges)if n==0 or(s<=e(self.ranges[1])and a>=r(self.ranges[n]))then
...
t={e(l),r(m)}self:_collapseRangesFromTo(n,i)table.insert(self.ranges,n,t)self:_checkCombineNeighborsAt(n)return
elseif not s and not o then
local e=a<e(m)if e then i=i-1 end
self:_collapseRangesFromTo(n,i)table.insert(self.ranges,n,t)self:_checkCombineNeighborsAt(n)return
else
if s then
self:_collapseRangesFromTo(n+1,i)self.ranges[n][2]=r(t)self:_checkCombineNeighborsAt(n)elseif o then
i=i-self:_collapseRangesFromTo(n,i-1)self.ranges[i][1]=e(t)self:_checkCombineNeighborsAt(i)end
return
end
end
...
function FDMMYearRange:removeYearRange(a,t)assert(type(a)=='number',"Invalid parameter: startYear")assert(type(t)=='number',"Invalid parameter: endYear")local n=table.getn(self.ranges)if n==0 or(a<=e(self.ranges[1])and t>=r(self.ranges[n]))then
self.ranges={}return
end
local c={a,t}local i=self:_indexOfRangeAdjToOrCont(a)local l=i and self.ranges[i]or nil
local n=self:_indexOfRangeAdjToOrCont(t)local s=n and self.ranges[n]or nil
local u=o(a,l)local m=o(t,s)local o=a<=e(l)local d=t<e(s)local e=t>=r(s)if o and(d or e)then
if d then n=n-1 end
self:_collapseRangesFromTo(i,n)return
elseif i==n and u and m then
...
if not e then s=n-1 end
n=n-self:_collapseRangesFromTo(r,s)if not o and u then
self.ranges[i][2]=a-1
self:_checkValidRangeAt(i)elseif not e and m then
self.ranges[n][1]=t+1
self:_checkValidRangeAt(n)end
return
end
...
function fdmm.regimentTypes._objForYear(n,t)if type(n)=='table'then
local i=nil
for e,r in ipairs(table.sortedKeysList(n))do
assert(type(r)=='number',"Invalid format: startYear")local e=n[r]assert(type(e)~='nil',"Invalid format.")if t==r then return e end
if t<r then return i or e end
i=e
end
return i
end
...
function fdmm.regimentTypes.dumpRegimentYearlyAvailability(o,a,t)env.info("FDMM: Dumping regiment yearly availability for years "..tostring(a).." to "..tostring(t).."...")local function i(n,e,r)env.info("FDMM: "..r.."Regiment: "..fdmm.regimentTypes.getObjReportNameInYear(n,e))for i,n in pairs(n.Units or{})do
...
setmetatable(FDMMResourceUnit,{__call=function(e,...)return e.new(...)end,})function FDMMResourceUnit.new(n,t,a,i,r,o)local e=setmetatable({},FDMMResourceUnit)e.fuelRP=n
e.armsRP=t
e.unitRP=a
e.maxFuelRP=i
e.maxArmsRP=r
...
function fdmm.territory.closestTerritoryToPoint(e,r)local n=mist.utils.makeVec2(e)local e=nil
local i=0
local r=r or fdmm.enums.TerritoryType.All
local r=fdmm.territories[r]for t,r in pairs(r)do
local n=mist.utils.get2DDistSqrd(n,r.centerPoint)if e==nil or n<i then
e=r
i=n
end
end
...
fdmm.regimentTypes.dumpRegimentYearlyAvailability(fdmm.consts.RegimentType.Caucasus.Ship.USA.Divisions.SixthFleet,1968,2020)if fdmm.runMode==fdmm.RunMode.DevWithPostTests then
fdmm.config.runTestsScript()end
end
